...
import { SuperadminOwnershipRequestsTable } from "@/components/SuperadminOwnershipRequestsTable";
...
const Index = () => {
  ...
  const slides = [
    ...
    <div key="transfer-permission-before-cd" className="min-h-screen bg-gradient-to-br from-background via-accent/5 to-background">
      ...
      <div className="flex w-full pt-[8.5rem]">
        <DashboardSidebar 
          activeSection="transfer-permission-before-cd"
          onSectionChange={() => {}}
        />
        
        <main className="flex-1 p-8 overflow-y-auto max-h-[calc(100vh-8.5rem)]">
          <div className="max-w-7xl mx-auto">
            <TransferPermissionBeforeCDForm />
          </div>
        </main>
      </div>
    </div>,
    ...
    // Slide 28: Superadmin Application Management (New)
    <div key="superadmin-app-mgmt-new" className="min-h-screen bg-gradient-to-br from-background via-accent/5 to-background">
      <DashboardHeader />
      ...
      <div className="flex w-full pt-[8.5rem]">
        ...
        <main className="flex-1 p-8 overflow-y-auto max-h-[calc(100vh-8.5rem)]">
          <SuperadminApplicationManagementNew />
        </main>
      </div>
    </div>,
    ...
    // Slide 29: Superadmin Application Management
    <div key="superadmin-app-mgmt" className="min-h-screen bg-gradient-to-br from-background via-accent/5 to-background">
      <DashboardHeader />
    ...
    // Slide 30: Application Management with Statistics
    <PresentationSlide key="application-management" gradient="none">
    ...
    // Slide 32: Superadmin - Manage Ownership Change Requests
    <div key="superadmin-ownership-requests" className="min-h-screen bg-gradient-to-br from-background via-accent/5 to-background">
      <DashboardHeader />
      ...
      <div className="flex w-full pt-[8.5rem]">
        ...
        <main className="flex-1 p-8 overflow-y-auto max-h-[calc(100vh-8.5rem)]">
          <SuperadminOwnershipRequestsTable />
        </main>
      </div>
    </div>,
  ];
