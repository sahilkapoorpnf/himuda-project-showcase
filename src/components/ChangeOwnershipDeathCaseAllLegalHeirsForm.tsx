...
export const ChangeOwnershipDeathCaseAllLegalHeirsForm = () => {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold mb-2">Change of Ownership (Death Case All Legal Heirs)</h1>
        <p className="text-muted-foreground">Submit request for change of ownership - All Legal Heirs case</p>
      </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Legal heirs who will receive the property</CardDescription>
            </CardHeader>
            ...
            <CardContent className="space-y-4">
              <div className="space-y-4 p-4 bg-accent/10 rounded-lg">
                ...
                <ul className="list-decimal list-inside space-y-2 text-sm">
                  ...
                  <li>
                    <span>Succession Certificate issued by competent authority (Physical verification required)</span>
                  </li>
                  <li>
                    <span>Legal Heir Certificate from Revenue Department (Physical verification required)</span>
                  </li>
                  <li>
                    <span>No objection from all legal heirs in prescribed format (Physical verification required)</span>
                  </li>
                  <li>
                    <span>Clearance of previous mortgage/Loan/Redemption Deed</span>
                  </li>
                  <li>
                    <span>Liability Affidavit of all legal heirs (Physical verification required)</span>
                  </li>
                  <li>
                    <span>Identity proof of all legal heirs (Physical verification required)</span>
                  </li>
                </ul>
              </div>
            </CardContent>
