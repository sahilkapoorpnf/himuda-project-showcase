...
export const NoDueCertificateForm = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    toast.success("No Due Certificate request submitted successfully!");
  ...
  if (!showForm) {
    return (
      <div className="max-w-2xl mx-auto">
        <Card>
          <CardHeader>
            <CardTitle>Issue of No Due Certificate</CardTitle>
            <CardDescription>Enter UPN number to proceed with No Due Certificate application</CardDescription>
          </CardHeader>
          <CardContent>
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <Card>
        <CardHeader>
          <CardTitle>No Due Certificate Application Form</CardTitle>
          <CardDescription>Complete the form below to apply for No Due Certificate</CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="space-y-4">
              <h3 className="text-lg font-semibold flex items-center gap-2">
                📄 Instruction For Documents Required for Physical Verification at HIMUDA Office
              </h3>
              <div className="bg-muted/50 p-4 rounded-lg space-y-2 text-sm">
                <p className="font-medium">Please bring the following document for physical verification:</p>
                <ul className="list-disc list-inside space-y-2 ml-2">
                  <li>Upload payment receipt in case payment details of transaction is not updated in system</li>
                </ul>
              </div>
            </div>
